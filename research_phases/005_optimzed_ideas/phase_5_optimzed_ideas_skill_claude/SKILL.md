---
name: phase-5-refine-methodology-claude
description: Refine a selected AI or computer-science research idea into a coherent, testable methodology. Use when Claude needs to define method objectives, framework modules, core mechanisms, algorithm flow, assumptions, risks, and an evaluation path before experiment design. Do not use to run experiments, fabricate results, or draft manuscript prose.
---
